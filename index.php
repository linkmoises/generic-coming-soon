...
<head>
  ...
  <meta name="author" content="Rackmed Technologies" />
</head>
<body>
    <section class="main" style="background-image: url(dist/src/images/bg.jpg);">
        <!-- Header Starts Here -->
        <header class="container">
            <nav>
                <div class="logo">
                    <a href="index.html">
                        <img src="dist/src/images/logo.png" width="100%"/>
                    </a>
                </div>
        ...
        <section class="newsletter-area">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <h5 class="has-line">Próximamente...</h5>
                        <h1>Estamos trabajando aquí...</h1>
                        <form action="#">
        ...
        <section class="xs-bg d-md-none d-lg-none">
            <img src="dist/src/images/xs.jpg" alt="img" class="img-fluid w-100">
        </section>
